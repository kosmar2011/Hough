...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 275231031, 275231031, 0)
    , catapult_monitor_INST("Monitor", clk, true, 275231031LL, 213558136LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2477025775, SC_NS);
    } else {
