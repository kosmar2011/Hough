...
solution design set {Hough_Algorithm_HW<1296, 864>::houghTransform} -block
solution design set {Hough_Algorithm_HW<1296, 864>::getMaxLine} -block
directive set -CLOCKS {clk {-CLOCK_PERIOD 0.67 -CLOCK_EDGE rising -CLOCK_UNCERTAINTY 0.0 -CLOCK_HIGH_TIME 0.335 -RESET_SYNC_NAME rst -RESET_ASYNC_NAME arst_n -RESET_KIND sync -RESET_SYNC_ACTIVE high -RESET_ASYNC_ACTIVE low -ENABLE_ACTIVE high}}
go assembly
...
directive set /Hough_Algorithm_HW<1296,864>/getMaxLine/core/for -PIPELINE_INIT_INTERVAL 1
directive set /Hough_Algorithm_HW<1296,864>/getMaxLine/core/T_LINE -PIPELINE_INIT_INTERVAL 3
go architect
go allocate
