...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 924837549, 924837549, 0)
    , catapult_monitor_INST("Monitor", clk, true, 924837549LL, 861181055LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(8323439086, SC_NS);
    } else {
