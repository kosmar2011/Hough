...
# Loop constraints
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp CSTEPS_FROM {{. == 0}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main CSTEPS_FROM {{. == 2} {.. == 0}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/acc_tmp:vinit CSTEPS_FROM {{. == 2} {.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1 CSTEPS_FROM {{. == 9} {.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-1:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for CSTEPS_FROM {{. == 3} {.. == 4}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-2:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for CSTEPS_FROM {{. == 3} {.. == 7}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC CSTEPS_FROM {{. == 17} {.. == 2}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/WRITE CSTEPS_FROM {{. == 4} {.. == 1}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/WRITE/WRITE:io_write(acc) CSTEPS_FROM {{.. == 3}}

# Sync operation constraints

# Real operation constraints
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/acc_tmp:vinit/for:write_mem(acc_tmp:rsc.@) CSTEPS_FROM {{.. == 1}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-1:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for/for#1-1:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for:if:acc#2 CSTEPS_FROM {{.. == 3}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-1:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for/for#1-1:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for:else:acc#2 CSTEPS_FROM {{.. == 3}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-1:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for:mux#2 CSTEPS_FROM {{.. == 3}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-2:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for/for#1-2:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for:if:acc#2 CSTEPS_FROM {{.. == 3}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-2:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for/for#1-2:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for:else:acc#2 CSTEPS_FROM {{.. == 3}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-2:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:for:mux#5 CSTEPS_FROM {{.. == 3}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:acc CSTEPS_FROM {{.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:acc#4 CSTEPS_FROM {{.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(cos_out:rsc.@) CSTEPS_FROM {{.. == 3}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:mul CSTEPS_FROM {{.. == 5}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(sin_out:rsc.@) CSTEPS_FROM {{.. == 3}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:mul#1 CSTEPS_FROM {{.. == 5}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:acc#2 CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:round_r:acc CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:round_r:HACC:round_r:acc:conv_2f:acc CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#1 CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#2 CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:idx:acc CSTEPS_FROM {{.. == 9}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(acc_tmp:rsc.@) CSTEPS_FROM {{.. == 9}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-1:HACC:acc CSTEPS_FROM {{.. == 11}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:write_mem(acc_tmp:rsc.@) CSTEPS_FROM {{.. == 11}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(cos_out:rsc.@)#1 CSTEPS_FROM {{.. == 4}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-2:mul CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(sin_out:rsc.@)#1 CSTEPS_FROM {{.. == 4}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-2:mul#1 CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-2:acc#2 CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-2:round_r:acc CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-2:round_r:HACC:round_r:acc:conv_2f:acc CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#3 CSTEPS_FROM {{.. == 9}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#4 CSTEPS_FROM {{.. == 10}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#5 CSTEPS_FROM {{.. == 10}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-2:idx:acc CSTEPS_FROM {{.. == 11}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(acc_tmp:rsc.@)#1 CSTEPS_FROM {{.. == 12}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-2:HACC:acc CSTEPS_FROM {{.. == 14}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:write_mem(acc_tmp:rsc.@)#1 CSTEPS_FROM {{.. == 14}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(cos_out:rsc.@)#2 CSTEPS_FROM {{.. == 2}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-3:mul CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(sin_out:rsc.@)#2 CSTEPS_FROM {{.. == 2}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-3:mul#1 CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-3:acc#2 CSTEPS_FROM {{.. == 9}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-3:round_r:acc CSTEPS_FROM {{.. == 10}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-3:round_r:HACC:round_r:acc:conv_2f:acc CSTEPS_FROM {{.. == 10}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#6 CSTEPS_FROM {{.. == 11}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#7 CSTEPS_FROM {{.. == 12}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#8 CSTEPS_FROM {{.. == 12}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-3:idx:acc CSTEPS_FROM {{.. == 13}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(acc_tmp:rsc.@)#2 CSTEPS_FROM {{.. == 13}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-3:HACC:acc CSTEPS_FROM {{.. == 15}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:write_mem(acc_tmp:rsc.@)#2 CSTEPS_FROM {{.. == 15}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(cos_out:rsc.@)#3 CSTEPS_FROM {{.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:mul CSTEPS_FROM {{.. == 4}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(sin_out:rsc.@)#3 CSTEPS_FROM {{.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:mul#1 CSTEPS_FROM {{.. == 3}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:acc#2 CSTEPS_FROM {{.. == 5}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:round_r:acc CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:round_r:HACC:round_r:acc:conv_2f:acc CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#9 CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#10 CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:idx:acc#11 CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:idx:acc CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:read_mem(acc_tmp:rsc.@)#3 CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:HACC:acc CSTEPS_FROM {{.. == 13}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:write_mem(acc_tmp:rsc.@)#3 CSTEPS_FROM {{.. == 16}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC:acc CSTEPS_FROM {{.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/HROW/HCOL/HACC/HACC-4:operator<<8,false>:acc CSTEPS_FROM {{.. == 2}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/WRITE/WRITE:read_mem(acc_tmp:rsc.@) CSTEPS_FROM {{.. == 1}}
