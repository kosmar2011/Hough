...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 275110859, 275110859, 0)
    , catapult_monitor_INST("Monitor", clk, true, 275110859LL, 212443644LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2475898867, SC_NS);
    } else {
