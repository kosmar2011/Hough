ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /opt/mentor/catapult_10.5a/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
ifeq "$(QuestaSIM_Path)" ""
QuestaSIM_Path                                      := /opt/mentor/questasim/questasim/linux_x86_64
...
QuestaSIM_QHOME                                     := can't read "QHOME": no such variable
...
OSCI_SYSTEMC_INCLUDE                                := /opt/mentor/catapult_10.5a/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                    := /opt/mentor/catapult_10.5a/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                          := /opt/mentor/questasim/questasim/linux_x86_64
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                           := 
