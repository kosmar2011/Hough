...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 274451339, 274451339, 0)
    , catapult_monitor_INST("Monitor", clk, true, 274451339LL, 212443464LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2469961567, SC_NS);
    } else {
