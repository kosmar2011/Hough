...
public:
  ...
  sc_signal<sc_logic>                                     TLS_widthIn_rsc_vld;
  sc_signal<sc_logic>                                     TLS_widthIn_rsc_rdy;
  sc_signal<sc_logic>                                     TLS_widthIn_rsc_triosy_lz;
  sc_signal<sc_lv<10> >                                   TLS_heightIn_rsc_z;
  ...
  ccs_in_pipe_trans_rsc_v1<1,9,8,0,1,0,0,1 >              data_in_rsc_INST;
  ...
  ccs_in_pipe_trans_rsc_v1<1,10,11,0,1,0,0,1 >            widthIn_rsc_INST;
  ...
  sc_signal<sc_logic>                                     OFS_houghTransform_inst_houghTransform_core_inst_houghTransform_core_widthIn_rsci_inst_houghTransform_core_widthIn_rsci_widthIn_rsc_wait_ctrl_inst_widthIn_rsci_irdy_core_sct;
  sc_signal<sc_logic>                                     OFS_houghTransform_inst_houghTransform_core_inst_houghTransform_core_widthIn_rsci_inst_houghTransform_core_widthIn_rsci_widthIn_rsc_wait_ctrl_inst_widthIn_rsci_ivld;
  ...
  sc_signal<sc_logic>                                     OFS_widthIn_rsc_vld;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_widthIn_rsc_vld("TLS_widthIn_rsc_vld")
    , TLS_widthIn_rsc_rdy("TLS_widthIn_rsc_rdy")
    , TLS_widthIn_rsc_triosy_lz("TLS_widthIn_rsc_triosy_lz")
    , TLS_heightIn_rsc_z("TLS_heightIn_rsc_z")
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 274116134, 274116134, 0)
    , catapult_monitor_INST("Monitor", clk, true, 274116134LL, 212443239LL)
    ...
    , maxsimtime("maxsimtime")
  {
    ...
    Hough_Algorithm_HW_1296_864_INST.widthIn_rsc_vld(TLS_widthIn_rsc_vld);
    Hough_Algorithm_HW_1296_864_INST.widthIn_rsc_rdy(TLS_widthIn_rsc_rdy);
    Hough_Algorithm_HW_1296_864_INST.widthIn_rsc_triosy_lz(TLS_widthIn_rsc_triosy_lz);
    Hough_Algorithm_HW_1296_864_INST.heightIn_rsc_z(TLS_heightIn_rsc_z);
    ...
    data_in_rsc_INST.en(SIG_SC_LOGIC_0);
    data_in_rsc_INST.arst(rst);
    data_in_rsc_INST.srst(TLS_rst);
    ...
    widthIn_rsc_INST.en(SIG_SC_LOGIC_0);
    widthIn_rsc_INST.arst(rst);
    widthIn_rsc_INST.srst(TLS_rst);
    widthIn_rsc_INST.rdy(TLS_widthIn_rsc_rdy);
    widthIn_rsc_INST.vld(TLS_widthIn_rsc_vld);
    ...
    heightIn_rsc_INST.z(TLS_heightIn_rsc_z);
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_houghTransform_inst_houghTransform_core_inst_houghTransform_core_widthIn_rsci_inst_houghTransform_core_widthIn_rsci_widthIn_rsc_wait_ctrl_inst_widthIn_rsci_irdy_core_sct,
      /scverify_top/rtl/houghTransform_inst/houghTransform_core_inst/houghTransform_core_widthIn_rsci_inst/houghTransform_core_widthIn_rsci_widthIn_rsc_wait_ctrl_inst/widthIn_rsci_irdy_core_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_houghTransform_inst_houghTransform_core_inst_houghTransform_core_widthIn_rsci_inst_houghTransform_core_widthIn_rsci_widthIn_rsc_wait_ctrl_inst_widthIn_rsci_ivld,
      /scverify_top/rtl/houghTransform_inst/houghTransform_core_inst/houghTransform_core_widthIn_rsci_inst/houghTransform_core_widthIn_rsci_widthIn_rsc_wait_ctrl_inst/widthIn_rsci_ivld);
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_widthIn_rsc_vld, /scverify_top/rtl/widthIn_rsc_vld);
#endif
#endif
}
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      && (OFS_widthIn_rsc_vld.read() == SC_LOGIC_1)
    ) {
      deadlocked.write(SC_LOGIC_1);
      deadlock_event.notify(2466991702, SC_NS);
    } else {
