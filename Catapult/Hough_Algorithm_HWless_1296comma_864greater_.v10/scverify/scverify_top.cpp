...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 275910857, 275910857, 0)
    , catapult_monitor_INST("Monitor", clk, true, 275910857LL, 213243642LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2483098849, SC_NS);
    } else {
