...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 275100779, 275100779, 0)
    , catapult_monitor_INST("Monitor", clk, true, 275100779LL, 212438604LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2475853507, SC_NS);
    } else {
