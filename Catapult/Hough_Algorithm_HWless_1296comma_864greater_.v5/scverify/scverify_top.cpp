...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 2102162309, 2102162309, 0)
    , catapult_monitor_INST("Monitor", clk, true, 2102162309LL, 2019390714LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(18919460737, SC_NS);
    } else {
