...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 276099734, 276099734, 0)
    , catapult_monitor_INST("Monitor", clk, true, 276099734LL, 212443239LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2484798742, SC_NS);
    } else {
