...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 121337840, 121337840, 0)
    , catapult_monitor_INST("Monitor", clk, true, 121337840LL, 119704714LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(1092040516, SC_NS);
    } else {
