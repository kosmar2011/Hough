...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 276099869, 276099869, 0)
    , catapult_monitor_INST("Monitor", clk, true, 276099869LL, 212443374LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2484799957, SC_NS);
    } else {
