...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1 CSTEPS_FROM {{. == 9} {.. == 1}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1:acc#3 CSTEPS_FROM {{.. == 1}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1:acc#4 CSTEPS_FROM {{.. == 2}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-1:for#1:acc CSTEPS_FROM {{.. == 3}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-1:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:if:acc CSTEPS_FROM {{.. == 4}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:write_mem(sin_out:rsc.@) CSTEPS_FROM {{.. == 4}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:write_mem(cos_out:rsc.@) CSTEPS_FROM {{.. == 4}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1:acc#5 CSTEPS_FROM {{.. == 5}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1:acc#6 CSTEPS_FROM {{.. == 5}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1:acc#7 CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1:acc CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:if:acc CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-2:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:else:if:acc#1 CSTEPS_FROM {{.. == 6}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:and#1 CSTEPS_FROM {{.. == 6}}
...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:write_mem(sin_out:rsc.@)#1 CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/ac_math::ac_sincos_cordic<52,10,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP>:write_mem(cos_out:rsc.@)#1 CSTEPS_FROM {{.. == 7}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1:slc(for#1-2:for#1:acc CSTEPS_FROM {{.. == 8}}
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/core:rlp/main/for#1/for#1-2:acc CSTEPS_FROM {{.. == 9}}
...
directive set /Hough_Algorithm_HW<1296,864>/getMaxLine/core/core:rlp/main/R_LINE/T_LINE/ac_math::ac_div<20,15,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP,20,15,AC_TRN,AC_WRAP>:else:else:acc#2 CSTEPS_FROM {{.. == 9}}
...
directive set /Hough_Algorithm_HW<1296,864>/getMaxLine/core/core:rlp/main/R_LINE/T_LINE/ac_math::ac_div<20,15,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP,20,15,AC_TRN,AC_WRAP>#2:else:else:acc#2 CSTEPS_FROM {{.. == 15}}
...
directive set /Hough_Algorithm_HW<1296,864>/getMaxLine/core/core:rlp/main/R_LINE/T_LINE/ac_math::ac_div<20,15,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP,20,15,AC_TRN,AC_WRAP>#4:else:else:acc#2 CSTEPS_FROM {{.. == 8}}
...
directive set /Hough_Algorithm_HW<1296,864>/getMaxLine/core/core:rlp/main/R_LINE/T_LINE/ac_math::ac_div<20,15,AC_TRN,AC_WRAP,27,3,AC_TRN,AC_WRAP,20,15,AC_TRN,AC_WRAP>#6:else:else:acc#2 CSTEPS_FROM {{.. == 13}}
