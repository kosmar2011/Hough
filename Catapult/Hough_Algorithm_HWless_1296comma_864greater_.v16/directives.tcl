...
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/WRITE -PIPELINE_INIT_INTERVAL 0
directive set /Hough_Algorithm_HW<1296,864>/houghTransform/core/WRITE -UNROLL yes
go loops
