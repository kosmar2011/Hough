...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 276219416, 276219416, 0)
    , catapult_monitor_INST("Monitor", clk, true, 276219416LL, 213558136LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(2485929295, SC_NS);
    } else {
